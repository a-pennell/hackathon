...
import type { Commitments, Listing, ManifestGroup, NoteDoc, NoteView, ProblemView, VisitData } from "./v2types";
...
export const api = {
  ...
  previewVisit: (pid: string, body: { decisions: Record<string, string>; reasons: Record<string, string>; authored: string; sections?: { key: string; text: string }[] }) => req<{ document: NoteDoc; manifest: ManifestGroup[] }>(`/v3/api/patients/${pid}/visit/preview${q()}`, post(body)),
